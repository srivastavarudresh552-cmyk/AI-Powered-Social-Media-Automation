        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div>
              ...
              <textarea required rows={5} maxLength={280} placeholder="What do you want to share today?"
                className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 text-sm placeholder-slate-400 outline-none resize-none" value={content} onChange={(e) => setContent(e.target.value)} />
      ...
      <div className="flex-1 flex flex-col gap-6 min-w-0">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div className="flex items-center gap-2.5 px-5 py-4 border-b border-slate-100">
            <CalendarDaysIcon className="size-5 text-zinc-500" />
        ...
        {/* Published */}
         <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div className="flex items-center gap-2.5 px-5 py-4 border-b border-slate-100">
            <SendIcon className="size-5 text-zinc-500" />
